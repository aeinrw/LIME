...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.origin_gb = QtWidgets.QGroupBox(self.centralwidget)
        self.origin_gb.setObjectName("origin_gb")
        self.horizontalLayout_2.addWidget(self.origin_gb)
        self.enhanced_gb = QtWidgets.QGroupBox(self.centralwidget)
        self.enhanced_gb.setObjectName("enhanced_gb")
        self.horizontalLayout_2.addWidget(self.enhanced_gb)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.origin_gb.setTitle(_translate("MainWindow", "原始图片"))
        self.enhanced_gb.setTitle(_translate("MainWindow", "增强后的图片"))
