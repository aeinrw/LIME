...
class LIME:
    ...
    def __toeplitzMatrix(self):
        ...
        D_v = np.kron(np.identity(self.col), self.d_v)
        D_h = np.kron(self.d_h.T, np.identity(self.row))
...
if __name__ == "__main__":
    lime = LIME("C:/Source/LIME/data/small.bmp")
    io.imsave('./result4.jpg', lime.enhance())
